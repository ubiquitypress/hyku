# copied over from hyrax, to override method `display_share_button?`
...
module Hyrax
  class HomepagePresenter
    ...
    #
    ## Ubiquity: In our instance for British Library, we do not want to display the "share your work" button
    ## To display it - uncomment the code within the method below and remove false.
