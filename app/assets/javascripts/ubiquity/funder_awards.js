$(document).on("turbolinks:load", function(){
  $(document).on('click', ".add_another_funder_awards_button", function(e) { //on add input button click
    ...
    if (cloneElement.find('input').val() != '') {
      ...
      cloneElement.append('<span class="input-group-btn field-controls"><a href="#" style="color:red;" class="remove_funder_awards_field btn"><span class="glyphicon glyphicon-remove"></span>Remove Funder Awards</a></span>');
