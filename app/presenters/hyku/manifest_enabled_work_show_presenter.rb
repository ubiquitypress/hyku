module Hyku
  class ManifestEnabledWorkShowPresenter < Hyrax::WorkShowPresenter
    ...
    delegate :extent, :rendering_ids, :isni, :institution, :org_unit, :refereed, :doi, :isbn, :issn, :eissn,
             ...
             :dewey, :library_of_congress_classification, :alt_title, :current_he_institution, :additional_links, :degree, :source, :irb_number, :irb_status, :qualification_name, :qualification_level, 
             to: :solr_document
