...
module Hyrax
  class BookContributionForm < Hyrax::Forms::WorkForm
    ...
    self.terms += %i[title alternative_title resource_type creator contributor date_published abstract institution
                     ...
                     related_identifier refereed keyword library_of_congress_classification
