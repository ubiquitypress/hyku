  ...
  module AllFormsSharedBehaviour
    ...
    included do
      ...
      attr_accessor :creator_group, :creator_name_type, :creator_organization_name, :creator_given_name,
                    ...
                    :creator_position, :creator_institutional_relationship, :creator_suffix, :affiliation, :role, :middle_name
      ...
      def build_permitted_params
        super.tap do |permitted_params|
          ...
          permitted_params << {creator_group: [:creator_organization_name, :creator_given_name,
            ...
            :creator_position, :creator_suffix, :affiliation, :role, :middle_name, :creator_institutional_relationship => []
          ]}
