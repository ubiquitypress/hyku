...
module Hyrax
  class ImageForm < Hyrax::Forms::WorkForm
    ...
    self.terms += %i[title  alternate_title resource_type creator contributor abstract date_published media institution
                     ...
                     rendering_ids keyword library_of_congress_classification add_info
                    ]
  end
end
