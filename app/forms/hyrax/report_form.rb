...
module Hyrax
  class ReportForm < Hyrax::Forms::WorkForm
    ...
    self.terms += %i[title  alternative_title resource_type creator contributor abstract date_published institution org_unit project_name
                     ...
                     refereed keyword library_of_congress_classification add_info rendering_ids
                    ]
  end
end
